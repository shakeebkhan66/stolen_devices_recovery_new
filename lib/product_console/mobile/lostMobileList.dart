...
import 'package:stolen_devices_recovery/product_console/mobile/searchLostMobile.dart';
...
class _LostMobileListState extends State<LostMobileList> {
  ...
  void displayLostMobileImageWithData(String mobileName, String mobileIMEI,
      String mobileContact, String mobilePurDate, String imageUrl, DateTime time) {
    showDialog(
      context: context,
      builder: (context) {
        return AlertDialog(
