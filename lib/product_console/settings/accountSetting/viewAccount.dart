...
import 'package:stolen_devices_recovery/product_console/settings/accountSetting/deleteAccount.dart';
...
class _ViewAccountState extends State<ViewAccount> {
  ...
  Map<String, dynamic>? searchedUserMap;
  bool isLoading = false;

  /// Read user account details
  Future<void> readUserAccountDetails() async {
    setState(() {
      isLoading = true;
    ...
    try {
      DocumentSnapshot snapshot = await _user
      ...
      if (snapshot.exists) {
        setState(() {
          searchedUserMap = snapshot.data() as Map<String, dynamic>;
          isLoading = false;
        });
      }
    } catch (error) {
      print("Error fetching user account details: $error");
      setState(() {
        isLoading = false;
      });
    }
                  ...
                  children: [
                    ...
                    TextButton.icon(
                      ...
                      style: TextButton.styleFrom(
                        ...
                        backgroundColor: Color(0xff80000d),
                      ),
